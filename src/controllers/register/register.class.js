...
var register_Sql_1 = require("db_sql/register.Sql");
var RegisterClass = /** @class */ (function () {
    // constructor는 객체를 생성하고 초기화 해주는 메서드임
    function RegisterClass(url) {
        this.body = url; // 프론트에서 받아온 req 값을 user.body에 저장함.
    }
    RegisterClass.prototype.register = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, register_Sql_1["default"].Register(client)];
                    case 2:
                        response = _a.sent();
